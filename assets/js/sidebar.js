...
(function () {
  const NAV = [
    ...
    },
    {
      section: '誰が・なぜ・どう',
      items: [
        { id: 'ch2-1', num: '2-1', emoji: '👥', label: 'プレイヤー図鑑', href: 'pages/chapter2-1.html' },
        ...
        { id: 'ch2-5', num: '2-5', emoji: '📂', label: '書類図鑑', href: 'pages/chapter2-5.html' },
      ],
    },
    {
      section: '業界の構造課題',
      items: [
        { id: 'ch3', num: '3', emoji: '🧱', label: '4つの構造課題', href: 'pages/chapter3.html' },
      ],
    },
    {
      section: 'WHEREの全容と価値',
      items: [
        { id: 'ch4-0', num: '4-0', emoji: '🧭', label: '機能全容', href: 'pages/chapter4-0.html' },
        { id: 'ch4-1', num: '4-1', emoji: '✨', label: '3つのコア価値', href: 'pages/chapter4-1.html' },
        { id: 'ch4-2', num: '4-2', emoji: '🎯', label: 'ユースケース', href: 'pages/chapter4-2.html' },
        { id: 'ch4-3', num: '4-3', emoji: '💬', label: '顧客の声', href: 'pages/chapter4-3.html' },
      ],
    },
    {
      section: 'リファレンス',
      items: [
        { id: 'glossary', num: '5', emoji: '📚', label: '重要用語集', href: 'pages/glossary.html' },
        { id: 'quiz', num: '6', emoji: '🎓', label: '理解度チェック', href: 'pages/quiz.html' },
    ...
    for (const entry of NAV) {
      if (entry.isHome) {
        ...
        for (const it of entry.items) {
          ...
          html += `<a class="${cls}" href="${linkTo(it.href)}"><span class="num">${it.num}</span><span>${it.emoji} ${it.label}</span></a>`;
        }
      }
    }
